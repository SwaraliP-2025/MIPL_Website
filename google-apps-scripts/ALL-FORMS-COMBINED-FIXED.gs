...
function doPost(e) {
  try {
    ...
    } else if (data.serviceInterest !== undefined) {
      return handleContactForm(data);
    } else if (data.rating) {
      return handleCTBFeedbackForm(data);
    }
...
function setupLoginCredentials() {
  ...
  console.log('Login credentials setup complete');
}
...
// ============================================================================
// CAREERS FORM - WITH DRIVE UPLOAD (USING WORKING PATTERN)
// ============================================================================
...
function handleCareersForm(data) {
  ...
  // Upload resume using WORKING pattern from Project Dashboard
  var resumeUrl = "";
...
// ============================================================================
// RESUME UPLOAD - EXACT PATTERN FROM PROJECT DASHBOARD
// ============================================================================
...
function uploadResumeToDrive(firstName, lastName, fileName, fileData) {
  try {
    ...
    // Get or create folder - EXACT pattern from Project Dashboard
    ...
    // Decode and create blob - EXACT pattern from Project Dashboard
...
// Helper function from Project Dashboard
