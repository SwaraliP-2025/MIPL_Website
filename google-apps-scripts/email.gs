function doPost(e) {
  try {
    ...
    Logger.log('Original timestamp: ' + timestamp);
    Logger.log('Formatted timestamp: ' + formattedTimestamp);
    ...
    var rowData = [
      ...
      "'" + formattedTimestamp  // Prefix with apostrophe to force text format
    ];
    
    sheet.appendRow(rowData);
    Logger.log('Data saved to sheet with formatted timestamp');
